...
public final class Questao {
    ...
    public Questao(String identificacao, String pergunta, String opcaoA, String opcaoB, String opcaoC, String opcaoD, char resposta, 
            String area, String grupo) {
    ...
    public String toString() {
        ...
        return (new StringBuilder("  "))
            ...
            .append(Atributo.montarTam(opcao, 44)).append("    ").append(marcar ? "Sim" : "N\343o").toString();
    }
}
